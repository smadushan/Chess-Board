...
//Red Boxes
var RedBoxes=['b8','d8','f8','h8','a7','c7','e7','g7','b6','d6','f6','h6','a5','c5','e5','g5','b4','d4','f4','h4','a3','c3','e3','g3','b2','d2','f2','h2','a1','c1','e1','g1'];
//Balck Team
var BalckTeam=['RB1','KNB1','BB1','KB','QB','BB2','KB2','RB2','PB1','PB2','PB3','PB4','PB5','PB6','PB7','PB8'];
//Red Team
var RedTeam=['RR1','KNR1','BR1','KR','QR','BR2','KNR2','RR2','PR1','PR2','PR3','PR4','PR5','PR6','PR7','PR8'];
...
function refreshBoxes() {
    for(var i=0;i<col.length;i++){
        for(var j=0;j<row.length;j++){
            ...
            for(var k=0;k<RedBoxes.length;k++){
                if(col[i]+row[j] === RedBoxes[k]){
                    $("#"+col[i]+row[j]).removeClass('TrapBox');
                    $("#"+col[i]+row[j]).removeClass('selectedBox');
                    $("#"+col[i]+row[j]).addClass('whiteBox');
                    $("#"+col[i]+row[j]).attr('ondrop','');
            ...
            if(parentId === col[i]+row[j]){
                ...
                for(var k=1;k<=8;k++){
                    if($("#"+col[i]+row[j-k]).find("img").length > 0){
                        ...
                        for(var b=0;b<BalckTeam.length;b++){
                            if($(chil).attr('id')===BalckTeam[b]){
                                break;
                            }
                        }
                        for(var r=0;r<RedTeam.length;r++){
                            if($(chil).attr('id')===RedTeam[r]){
